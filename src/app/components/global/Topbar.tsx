...
export const Topbar = () => {
    ...
    return (<div>
        <div className="navbar">
            <a className="btn btn-ghost text-[32px] text-primary">Movie Diary</a>
            <label className="swap swap-rotate origin-top-right absolute right-5">
                <input type="checkbox" checked={isChecked} className="theme-controller" value="synthwave"
